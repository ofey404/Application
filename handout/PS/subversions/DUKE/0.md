...
Write a statement (1-2 pages, single-spaced, in a 12-point font) indicating 

- [x] your purposes and objectives in undertaking graduate study,
- [x] your special interests and plans,
- [x] and your strengths and weaknesses in your chosen field.
- [x] Briefly describe any research projects or any independent research in which you have actively participated and indicate how this has influenced your career choice and desire to pursue graduate studies.

Additional Statement of Purpose information or focus may be requested by some departments.

Check with your program of interest for details. You can access your program’s website from this link:


Computer Science Requirement (Project based): https://www.cs.duke.edu/graduate/ms_requirements
...
In the long run, an open-source leader is what I want to be. This path needs more than just devotion, but also maturity in engineering and a holistic understanding of technical, economic, and social issues. I believe DUKE could be my portal to larger context, connecting to the widest possible array of experts, facilities and resources, and your focus on interdisciplinary collaboration could provide more hands-on experiences.

I bring a roadmap, if I have the honor to be accepted. To build my muscle for real world problems and finally deliver my VCS, I would choose project option in the MS program. First year may be tough, but I'll search for my advisor early, especially in the research area of Database and Distributed Systems. I would take 344 Computer Graphics and 516	Database Systems early, to build a solid knowledge base on data management. What's more, I would seek possible advisory or collaboration chance from the Department of Art, Art History & Visual Studies.
